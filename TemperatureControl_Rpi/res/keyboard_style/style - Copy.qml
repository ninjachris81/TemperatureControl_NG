...
KeyboardStyle {
    ...
    readonly property string fontFamily: VariantConfigurationManager.fontFamily
    ...
    keyboardDesignWidth: 800 * 3
    keyboardDesignHeight: 480 * 3
    ...
    keyboardBackground: Rectangle {
        color: VariantConfigurationManager.brightBackgroundColor
    }
