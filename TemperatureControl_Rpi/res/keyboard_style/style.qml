...
KeyboardStyle {
    ...
    readonly property string fontFamily: "Helvetica 65 Medium"
    ...
    readonly property color darkKeyColor: "#11100e"
    ...
    hideKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                id: hideKeyIcon
                anchors.centerIn: parent
                sourceSize.width: 220 * keyIconScale
                sourceSize.height: 170 * keyIconScale
                smooth: false
                source: resourcePrefix + "images/arrow_downwards.svg"
            }
        }
        states: [
            State {
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        source: resourcePrefix + "images/shift-868482_active.svg"
                    }
                },
                State {
                    name: "shift"
    ...
    spaceKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                id: spaceKeyText
                anchors.centerIn: parent
                sourceSize.width: 280 * keyIconScale
                sourceSize.height: 280 * keyIconScale
                smooth: false
                source: resourcePrefix + "images/spacebar.svg"
            }
    ...
    fullScreenInputMargins: 10//Math.round(15 * scaleHint)

    fullScreenInputPadding: 0//Math.round(30 * scaleHint)
    ...
    fullScreenInputFont.pointSize: 26
    fullScreenInputFont.family: "Helvetica 65 Medium"
